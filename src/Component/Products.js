      ...
      <>
        <div className=" max-w-7xl mx-auto   flex  flex-col p-3  sm:my-20">
          <div className=" my-4 flex  justify-between items-center ">
            <div>
              <h1 className="text-white text-xl lg:text-3xl 2xl:text-4xl  font-medium">
                Explore Product
              </h1>
            </div>
            ...
            <div className=" ">
              ...
              >
                {" "}
                <span className="flex rounded-md items-center space-x-3 buttonBg  py-2 px-4 lg:px-6 xl:py-3 xl:px-10  transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-105 duration-300">
          ...
          <div className="sm:grid max-w-7xl mx-auto gap-x-10   grid-cols-1 sm:grid-cols-2  md:grid-cols-3 xl:grid-cols-4  md:gap-x-5 lg:gap-x-16 xl:gap-x-5 gap-5 flex flex-col  justify-center items-center  sm:p-0 p-3 my-4">
