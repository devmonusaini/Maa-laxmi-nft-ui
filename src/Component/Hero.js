    ...
    <>
      <div className="bg-cover bg-vulcan bg-no-repeat bg-center mt-[-105px] md:mt-[-131px] px-3 pt-20 md:pt-40 pb-12 lg:block xl:px-0 w-screen">
        <div className="lg:grid max-w-7xl mx-auto gap-x-10 grid-cols-1 gap-y-10 md:grid-cols-2 md:gap-y-0 xl:gap-x-20 flex justify-center items-center flex-col flex-col-reverse ">
          ...
          <div
            className="w-full rounded-xl py-6  mb-6  flex 2xl:justify-end xl:justify-center  lg:justify-end sm:justify-start justify-center items-center "
            data-aos="zoom-in-left"
          >
            <div className="bg-transparent text-center px-4 py-2 sm:pt-3   rounded-xl boxbgColor  max-w-[320px] ">
        ...
        <div className="lg:grid max-w-7xl mx-auto gap-x-10 grid-cols-1 gap-y-1 xl:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 md:gap-y-0 xl:gap-x-20 my-10 hidden">
        ...
        <div
          className="mediaClass  max-h-[380px] 2xl:w-[230px] w-[160px] text-center pl-4 py-2 sm:pt-3 sm:px-18 absolute top-40 right-0  bg-slate-900 rounded-xl overflow-hidden xl:flex hidden  -z-50 "
          data-aos="zoom-in"
        >
          <img alt="images" className="my-5 ml-2 w-full" src={img2} />
        </div>
      </div>
    </>
  );
