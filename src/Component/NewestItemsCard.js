...
const NewestItemsCard = (props) => {
  ...
  return (
      ...
      >
        <div className="  w-full rounded-xl     flex 3xl:justify-end justify-center items-center  mx-2  hover:scale-105 duration-500">
          <div className="w-full bg-gray-800  text-center px-6 py-2 sm:pt-3  HoverEffect rounded-xl relative ">
            <img alt="images" className="my-2 mt-4 w-full max-w-[250px] min-w-full  h-[245px] rounded-2xl" src={props.data.image} />
    ...
    //               className={
    //                 toggle === 1
    //                   ? "p-1 px-5 font-bold text-white buttons rounded-xl bg-gray-800 hover:bg-gray-800 "
    //                   : "p-1 px-5 font-bold text-white buttons rounded-xl boxbgColor hover:bg-gray-800 "
    //               }
    //             >
    //               Buy
    //             </button>
