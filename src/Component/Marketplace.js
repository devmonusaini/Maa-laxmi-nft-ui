  ...
  return (
    <>
      <div className=" max-w-7xl mx-auto  sm:my-20    flex  flex-col p-4  bg-black  shadowbox">
        ...
        <div className="lg:grid w-full mx-auto  grid-cols-1  md:grid-cols-5 md:gap-y-0  gap-5 flex flex-col  justify-center items-start py-4">
          <div className="  h-full rounded-2xl     w-full flex  justify-center items-center flex-col  col-span-2" >
            <div className="h-full p-10 sm:px-16 sm:py-20   inputBg  flex justify-center items-center flex-col md:max-w-2xl max-w-md  rounded-xl w-full  ">
              <img
          ...
          <div className="  rounded-xl py-4  bg-black mb-6    w-full col-span-3 lg:ml-10 lg:pr-10">
            ...
            <div className="text-white font-medium  text-xl md:text-2xl w-full text-start  my-2" >
              TestNFT01 <br />
              <span className=" text-sm sm:text-md lg:text-lg text-white ">
                Owned by <span className="text-[#f3b93d] font-bold">You</span>
              </span>
            </div>
            <div className="text-white font-medium text-sm sm:text-lg w-full text-start flex justify-start items-center   my-5 mb-10" >
              <span className="w-7  h-7  rounded-full bg-gray-200 mx-3"></span>{" "}
              12Views
              <span className="w-7  h-7  rounded-full bg-gray-200 mx-3"></span>
              14Arts
            </div>
            <div className=" boxBorder text-center  px-3 py-3   bg-black  rounded-xl space-y-4  " >
              <div
                className="   inputBg text-center   py-2     rounded-xl  flex  justify-between items-center "
                onClick={() => {
                  setToggle(!toggle);
                }}
              >
                <div className="flex justify-center items-center textColor font-semibold">
                  <span className="w-7  h-7  rounded-full boxbgColors boxtextColor mx-3"></span>{" "}
                  Price History
                </div>
                <div className="text-[#edae41] px-6">
                  {toggle ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
                </div>
              </div>
              {toggle ? (
                <div className=" boxbgColors text-center   py-3   bg-black  rounded-xl  flex  justify-between items-center  ">
        ...
        <div className=" boxBorder text-center  px-3 py-3   bg-black  rounded-xl  space-y-4 ">
          <div>
            ...
            >
              <div className="flex justify-center items-center text-[#edae41] font-semibold">
                <span className="w-7  h-7  rounded-full boxbgColors boxtextColor mx-3"></span>{" "}
                Description
              </div>
              <div className="text-[#edae41] px-6">
            ...
            {toggle1 ? (
              <div className="  text-center flex-col  py-2   bg-black  rounded-xl  flex  justify-between items-center my-4">
          ...
          <div>
            ...
            {toggle2 ? (
              <div className="  text-center flex-col  py-2   bg-black  rounded-xl  flex  justify-between items-center ">
          ...
          <div className=" boxBorder text-center  px-3 py-3   bg-black  rounded-xl  my-5 ">
