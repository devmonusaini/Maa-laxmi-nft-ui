    ...
    <>
      <div className=" max-w-7xl mx-auto gap-x-10  gap-y-10  sm:my-20 2xl:my-40  xl:gap-x-20 flex  flex-col  px-2">
        <div className=" gap-x-10  gap-y-10   xl:gap-x-20 flex  justify-between items-center " >
          <div>
            <h1 className="text-white text-xl md:text-2xl lg:text-3xl 2xl:text-4xl font-medium capitalize">Edit your Profile</h1>
          </div>
       ...
       <div className={toggle === 1 ?" block col-span-2 "  : "hidden col-span-2 "}>
        ...
        <div className="  my-2">
                            <button className="font-bold text-white text-xs xl:text-sm" href="/" target="_blank" rel="noreferrer"> <span className="flex rounded-md items-center space-x-3 boxbgColor  py-2 px-4 lg:px-6 xl:py-3 xl:px-8  transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-105 duration-300">
                            Upload Profile
                                </span>
                                </button>
                            </div> 
       ...
       <div className="  border boxBorder rounded-xl py-8 col-span-2 bg-black mb-6 p-4  w-full"  >
        ...
        <option value="kiwi">city</option>
                 ...
                 <div className="   gap-y-10  w-full flex  justify-center sm:justify-end items-center  mt-10 " >
                   ...
                   <div className=" px-4 " >
                            <button className="font-medium text-white text-xs xl:text-sm" href="/" target="_blank" rel="noreferrer"> <span className="flex rounded-md items-center space-x-3 boxbgColor  py-2 px-4 lg:px-6 xl:py-3 xl:px-8  transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-105 duration-300">
                            Cancle
                                </span>
                                </button>
                            </div> 
